...
class _AgentProfileScreenState extends State<AgentProfileScreen> {
  ...
  Color _backgroundColor = const Color(0xFF0A0A0F); // 👈 estado propio del fondo
  ...
  void _onFactionSelected(Faction faction) {
    ...
    setState(() {
      ...
      // 👇 mezcla negro base con el color de la facción al 15%
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      color: _backgroundColor, // 👈 usa la variable de estado directamente
      child: Scaffold(
